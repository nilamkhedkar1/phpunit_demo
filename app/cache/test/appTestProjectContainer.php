...
class appTestProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'uploadBundle', ($this->targetDirs[2].'/Resources/uploadBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'uploadBundle', ($this->targetDirs[3].'/src/uploadBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'phpunit_sqlite_testing', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'path' => (__DIR__.'/test_phpunit_sqlite_testing.db'), 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/uploadBundle/Resources/config/doctrine') => 'uploadBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'uploadBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('uploadBundle' => 'uploadBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e191896e2da6ce0fa443cfcf79735801e864a279d79bb56be898082d1acf8bb5');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'uploadBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/uploadBundle/Resources/views'), 'upload');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \uploadBundle\Services\UserManager A uploadBundle\Services\UserManager instance
     */
    protected function getUserService()
    {
        return $this->services['user'] = new \uploadBundle\Services\UserManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('594111bb3e1213.12229250')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'uploadBundle' => 'uploadBundle\\uploadBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'uploadBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/uploadBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'phpunit_sqlite_testing',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => '192.168.3.178',
            'mailer_user' => NULL,
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '192.168.3.178',
